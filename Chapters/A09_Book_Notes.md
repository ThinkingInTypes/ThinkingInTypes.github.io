...
Python doesn’t support currying out of the box like some functional languages (e.g., Haskell), you can implement it using closures or with the functools module.
...
Here's a curry decorator for any two-arg function:
