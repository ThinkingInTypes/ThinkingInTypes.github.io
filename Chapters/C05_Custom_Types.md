...
You need a completely alternative interface, such as parsing inputs from a different format (e.g., strings, dicts, files) and then assigning to fields.
...
Prefer `__post_init__` for simple validation, transformation, or default adjustments after standard field initialization.
